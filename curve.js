/*!	Curve extension for canvas 2.3
 ...
 */
CanvasRenderingContext2D.prototype.curve = function (points, tension, numOfSeg, close,offsetX,offsetY) {
    ...
    var pts,									// for cloning point array
		rLen = (points.length - 2) * numOfSeg + 2 + (close ? 2 * numOfSeg : 0),
		rPos = 0,
    ...
    for (i = 0, l = res.length; i < l; i += 2)
        this.lineTo(res[i] + offsetX, res[i + 1]+offsetY);
